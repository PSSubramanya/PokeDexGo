...
const SampleTestingScreen = props => {
  ...
  const [text, setText] = useState(
    'Bulbasaur is a Grass/Poison type Pokémon. Bulbasaur is a small, mainly turquoise amphibian Pokémon with red eyes and a green bulb on its back. The bulb grows into a flower as it evolves. It is one of the three choices for a starter Pokémon in Kanto region.',
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.container}>
        ...
        <View style={{marginBottom: 300, height: 150}}>
          <FlatList
...
export default SampleTestingScreen;
